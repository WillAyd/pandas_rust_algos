...
use crate::groupby::{
    ...
    group_last_pyobject, group_mean, group_median_float64, group_min_max, group_nth,
...
fn pandas_rust_algos(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    fn group_cumprod_py<'py>(
        ...
        match (out, values) {
            (NumericArray2::I8(out), NumericArray2::I8(values)) => group_cumprod(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                ngroups,
            ...
            (NumericArray2::I16(out), NumericArray2::I16(values)) => group_cumprod(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                ngroups,
            ...
            (NumericArray2::I32(out), NumericArray2::I32(values)) => group_cumprod(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                ngroups,
            ...
            (NumericArray2::U8(out), NumericArray2::U8(values)) => group_cumprod(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                ngroups,
            ...
            (NumericArray2::U16(out), NumericArray2::U16(values)) => group_cumprod(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                ngroups,
            ...
            (NumericArray2::U32(out), NumericArray2::U32(values)) => group_cumprod(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                ngroups,
            ...
            (NumericArray2::U64(out), NumericArray2::U64(values)) => group_cumprod(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                ngroups,
    ...
    fn group_sum_py<'py>(
        ...
        match (out, values) {
            (NumericArray2::I8(out), NumericArray2::I8(values)) => group_sum(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::I16(out), NumericArray2::I16(values)) => group_sum(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::I32(out), NumericArray2::I32(values)) => group_sum(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U8(out), NumericArray2::U8(values)) => group_sum(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U16(out), NumericArray2::U16(values)) => group_sum(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U32(out), NumericArray2::U32(values)) => group_sum(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U64(out), NumericArray2::U64(values)) => group_sum(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
    ...
    fn group_prod_py<'py>(
        ...
        match (out, values) {
            (NumericArray2::I8(out), NumericArray2::I8(values)) => group_prod(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::I16(out), NumericArray2::I16(values)) => group_prod(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::I32(out), NumericArray2::I32(values)) => group_prod(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U8(out), NumericArray2::U8(values)) => group_prod(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U16(out), NumericArray2::U16(values)) => group_prod(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U32(out), NumericArray2::U32(values)) => group_prod(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U64(out), NumericArray2::U64(values)) => group_prod(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
    ...
    fn group_ohlc_py<'py>(
        ...
        match (out, values) {
            ...
            (NumericArray2::U64(out), NumericArray2::U64(values)) => group_ohlc(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
    ...
    fn group_quantile_py<'py>(
        ...
        match values {
            NumericArray1::I8(values) => group_quantile(
                out.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                mask.as_array_mut(),
            ...
            NumericArray1::I16(values) => group_quantile(
                out.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                mask.as_array_mut(),
            ...
            NumericArray1::I32(values) => group_quantile(
                out.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                mask.as_array_mut(),
            ...
            NumericArray1::U8(values) => group_quantile(
                out.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                mask.as_array_mut(),
            ...
            NumericArray1::U16(values) => group_quantile(
                out.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                mask.as_array_mut(),
            ...
            NumericArray1::U32(values) => group_quantile(
                out.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                mask.as_array_mut(),
            ...
            NumericArray1::U64(values) => group_quantile(
                out.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
                mask.as_array_mut(),
    ...
    fn group_nth_py<'py>(
        ...
        match (out, values) {
            (NumericAndObjectArray2::U8(out), NumericAndObjectArray2::U8(values)) => group_nth(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericAndObjectArray2::U16(out), NumericAndObjectArray2::U16(values)) => group_nth(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericAndObjectArray2::U32(out), NumericAndObjectArray2::U32(values)) => group_nth(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericAndObjectArray2::U64(out), NumericAndObjectArray2::U64(values)) => group_nth(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericAndObjectArray2::F32(out), NumericAndObjectArray2::F32(values)) => group_nth(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericAndObjectArray2::F64(out), NumericAndObjectArray2::F64(values)) => group_nth(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
    ...
    fn group_rank_py<'py>(
        ...
        _values: NumericAndObjectArray2,
    ...
    fn group_max_py<'py>(
        ...
        match (out, values) {
            (NumericArray2::I8(out), NumericArray2::I8(values)) => group_min_max(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::I16(out), NumericArray2::I16(values)) => group_min_max(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::I32(out), NumericArray2::I32(values)) => group_min_max(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U8(out), NumericArray2::U8(values)) => group_min_max(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U16(out), NumericArray2::U16(values)) => group_min_max(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U32(out), NumericArray2::U32(values)) => group_min_max(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
            ...
            (NumericArray2::U64(out), NumericArray2::U64(values)) => group_min_max(
                out.readwrite().as_array_mut(),
                counts.as_array_mut(),
                values.readonly().as_array(),
                labels.as_array(),
    ...
    fn group_cummin_py<'py>(
        ...
        match (out, values) {
            (NumericArray2::I8(out), NumericArray2::I8(values)) => group_cummin_max(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                mask,
                result_mask,
            ...
            (NumericArray2::I16(out), NumericArray2::I16(values)) => group_cummin_max(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                mask,
                result_mask,
            ...
            (NumericArray2::I32(out), NumericArray2::I32(values)) => group_cummin_max(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                mask,
                result_mask,
            ...
            (NumericArray2::U8(out), NumericArray2::U8(values)) => group_cummin_max(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                mask,
                result_mask,
            ...
            (NumericArray2::U16(out), NumericArray2::U16(values)) => group_cummin_max(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                mask,
                result_mask,
            ...
            (NumericArray2::U32(out), NumericArray2::U32(values)) => group_cummin_max(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                mask,
                result_mask,
            ...
            (NumericArray2::U64(out), NumericArray2::U64(values)) => group_cummin_max(
                out.readwrite().as_array_mut(),
                values.readonly().as_array(),
                mask,
                result_mask,
